...
def _controller_gen_action(ctx, cg_cmd, outputs, output_path):
    ...
    Args:
      ...
      output      - List of File/Dir produced by the action (declare dependencies)
...
def _controller_gen_impl(ctx):
    """ Run controller-gen in the sandbox with arbitrary input subcommands
    ...
    Args:
      ctx         - The Rule's context
      args        - The controller-gen arguments to run
      outs        - List of File/Dir produced by the action (declare dependencies)
    """
...
_controller_gen = rule(
    ...
    attrs = {
        ...
        "outs": attr.output_list(
            mandatory = True,
            allow_empty = False,
            doc = "The list of outputs generated by the target",
        ),
        "gopath_dep": attr.label(
            providers = [GoPath],
            mandatory = False,
    ...
    toolchains = _toolchains(),
    doc = "Run the controller-gen tool with arbitrary arguments",
)
